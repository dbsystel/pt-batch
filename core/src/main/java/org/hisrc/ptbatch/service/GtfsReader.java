...
public class GtfsReader {
    ...
    private final Logger LOGGER = LoggerFactory.getLogger(GtfsReader.class);
    ...
    // serviceIds.contains(trip.getServiceId())).findFirst().orElse(null);
    // }
    //
    ...
    // route -> Objects.equals(name, route.getLongName()) || Objects.equals(name,
    // route.getShortName()))
    // .findFirst().orElse(null);
    // }
    //
    // private ServiceDate createServiceDate(LocalDate date) {
    // final ServiceDate serviceDate = new ServiceDate(date.getYear(), date.getMonthValue(),
    // date.getDayOfMonth());
    // return serviceDate;
    // }
    ...
    private GtfsMutableRelationalDao loadDao(final File file) throws ZipException, IOException {
        ...
        final org.onebusaway.gtfs.serialization.GtfsReader reader = new org.onebusaway.gtfs.serialization.GtfsReader();
